...
- Lua command: freeline - adjusted documentation
- Lua command: freerect - adjusted documentation
...
- The `object` Lua command refused to accept `"tilex"` and `"tiley"` as parameters, that has now been fixed. ~ Thanks Margineanu65!
